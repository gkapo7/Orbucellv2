        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="text-center p-8 border-0 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full">
                <CardContent>
                  <div className="w-16 h-16 bg-gradient-to-r from-red-100 to-orange-100 rounded-full flex items-center justify-center mb-6 mx-auto">
